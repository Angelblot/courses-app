...
- Aucun mot de passe **du drive** n’est demandé : l’extension utilise sa session Chrome.
  La connexion au compte **Courses** permet de recevoir les listes de l’iPhone.
  Son mot de passe est envoyé à Supabase pour la connexion, puis effacé du champ ;
  seuls les jetons de session sont conservés dans le stockage local de l’extension.
