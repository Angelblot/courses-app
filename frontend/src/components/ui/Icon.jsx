const PATHS = {
  settings: <><path d="m9.5 3-.6 2.2-1.8 1.1-2.2-.6-2 3.5 1.6 1.6v2.3l-1.6 1.6 2 3.5 2.2-.6 1.8 1.1.6 2.3h4.1l.6-2.3 1.9-1.1 2.2.6 2-3.5-1.6-1.6v-2.3l1.6-1.6-2-3.5-2.2.6-1.9-1.1-.6-2.2Z"/><circle cx="11.6" cy="12" r="3"/></>,
