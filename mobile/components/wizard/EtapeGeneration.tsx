...
export function EtapeGeneration(){
 ...
 <Action disabled={disabled} onPress={send}>{sending?'Envoi en cours…':'Envoyer à mon ordinateur'}</Action><Action disabled={sending} secondary onPress={()=>router.replace('/wizard/recap')}>Modifier ma liste</Action>
 </ScrollView>
}
